...
const getInfoList =(workNum) => {
    // 查询个人信息 多表查询  登录后返回个人人物列表
    let sql = "select" +
        " user_work_number,user_name,user_werks ,task_name,task_type,create_time " +
        "from sp_users,sp_tasks,usersTotasks " +
        "WHERE sp_users.user_work_number = usersTotasks.user_id and sp_tasks.id = usersTotasks.task_id " +
        "and sp_users.user_work_number = "+`${workNum}`+ " ;"
    mysqlDB(sql,(msg)=>{
        this.msg = msg
    })
    return this.msg;
